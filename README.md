...
```bash
pip install -e . #you can also use: uv pip install -e . --python 3.10
pip install -r requirements.txt #you can also use: uv pip install -r requirements.txt --python 3.10
```
